...
class DataTransformation :
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Reding train and test data completed")
            ...
            train_arr = np.hstack((input_features_train_arr,np.array(target_feature_train_df).reshape(-1,1)))
            test_arr = np.hstack((input_features_test_arr,np.array(target_feature_test_df).reshape(-1,1)))
